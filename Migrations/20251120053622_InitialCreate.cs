    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LegacyUsers", x => x.userId);
                    table.ForeignKey(
                        name: "FK_LegacyUsers_Regions_regionId",
                        column: x => x.regionId,
                        principalTable: "Regions",
                        principalColumn: "RegionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LegacyUsers_Roles_roleId",
                        column: x => x.roleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LegacyUsers_regionId",
                table: "LegacyUsers",
                column: "regionId");

            migrationBuilder.CreateIndex(
                name: "IX_LegacyUsers_roleId",
                table: "LegacyUsers",
                column: "roleId");
        }
